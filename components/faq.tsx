      ...
      <section>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              A digital business card is an electronic version of a traditional
              business card that can be shared via QR code, email, text message,
              or social media. It contains your contact information, social
              media profiles, and other relevant details about you or your
              business.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              Yes, you can fully customize your digital business card with your
              own branding, colors, images, and content. You can also choose
              from various templates and layouts.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="account-2">
            ...
            <AccordionContent>
              ...
              professional plan with additional features. Visit our subscription
              plans page for detailed information.
            </AccordionContent>
          </AccordionItem>
      ...
      <section>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="tech-1">
            ...
            <AccordionContent>
              If your QR code isn&apos;t working, try regenerating it from your
              dashboard. Make sure the QR code has good contrast and is large
              enough to scan. If problems persist, contact our support team.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="tech-2">
            <AccordionTrigger>How do I update my information?</AccordionTrigger>
            <AccordionContent>
              If you want to update your personal or account information, simply
              sign in to your account, go to Settings, make your changes, and
              click &quot;Save Changes&quot;.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="tech-3">
            ...
            <AccordionContent>
              ...
              Click-Through Rate. The professional plan also includes additional
              insights with visual charts.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
